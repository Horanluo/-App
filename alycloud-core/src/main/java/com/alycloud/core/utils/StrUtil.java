...
//    }
	 ...
	 * @return
	 */
	public static String mkQrcodeKey() {
	...
	public static String paramVerify(Map<String,String> paramMap){
//		Iterator<Map.Entry<Integer, Integer>> entries = paramMap.entrySet().iterator(); 
//		for(entries.hasNext()){
//			
//		}
		return null;
