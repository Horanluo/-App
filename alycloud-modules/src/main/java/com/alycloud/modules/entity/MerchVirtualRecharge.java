...
public class MerchVirtualRecharge implements Serializable {
	...
	public String toString() {
		return "MerchVirtualRechargeBean [id=" + id + ", cardno=" + cardno + ", branchno=" + branchno + ", branchName="
				+ branchName + ", agentno=" + agentno + ", agentName=" + agentName + ", merchno=" + merchno
				+ ", merchName=" + merchName + ", type=" + type + ", amountBefore=" + amountBefore + ", amount="
				+ amount + ", amountAfter=" + amountAfter + ", status=" + status + ", remark=" + remark + ", refno="
				+ refno + ", loginName=" + loginName + ", addTime=" + addTime + ", ip=" + ip + "]";
	}
