...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = "com.alycloud.schedules")
@Slf4j
@Controller
public class SwaggerConfig extends WebMvcConfigurerAdapter implements EnvironmentAware
{
    ...
    public Docket swaggerSpringfoxDocket4KAD() {//
        ...
        Docket swaggerSpringMvcPlugin = new Docket(DocumentationType.SWAGGER_2)
                ...
                .paths(regex("/merchUserBank/listByPage|/changeMerchAccount/add|/merchInfo/upgradePay|/tran/withdrawalDetail|/login")) // and by paths
