...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = "com.alycloud.financial")
@Slf4j
public class SwaggerConfig extends WebMvcConfigurerAdapter implements EnvironmentAware
{
    private RelaxedPropertyResolver propertyResolver;
    
    @Value("${title:易商云-内部账务接口}")
    private String title;
    
    @Value("${description:账务接口，包括分润,收益等}")
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("financial-swagger-ui.html")
    ...
    public Docket swaggerSpringfoxDocket4KAD() {//
        ...
        Docket swaggerSpringMvcPlugin = new Docket(DocumentationType.SWAGGER_2)
                ...
                .paths(regex("/merchVirtualCard/draw|/agentTrans/overview|/agentTrans/sumAmount|/agentTrans/list4Day|/agentTrans/list4Detail"
                		+ "|/agentVirtualCard/draw|/agentVirtualTrans/sumAmount|/agentVirtualTrans/list4Day|/agentVirtualTrans/list4Detail"
                		+ "|/myBill/sumAmount|/myBill/list4Day|/myBill/list4Detail")) // and by paths
                .build();
        watch.stop();
